...
void Widget::OnMouseDown(common::int32_t x, common::int32_t y, uint8_t button) {
    if(Focussable)
        GetFocus(this);
}
...
void Widget::OnMouseUp(common::int32_t x, common::int32_t y, uint8_t button) {}
...
void CompositeWidget::OnMouseDown(common::int32_t x, common::int32_t y, uint8_t button) {
...
void CompositeWidget::OnMouseUp(common::int32_t x, common::int32_t y, uint8_t button) {
    for(int i = 0; i < numChildren; ++i)
        if(children[i]->ContainsCoordinate(x - this->x, y - this->y)) {
